const recipes = {
  nodes: [
    ...
    { id: "log", type: "input", x: 2680, y: 935, title: "Log" },
    { id: "craftAndesiteCasing", type: "process", x: 2970, y: 870, title: "Crafting", subtitle: "Alloy + log" },
    { id: "andesiteCasing", type: "output", x: 3260, y: 870, title: "Andesite Casing" },
    { id: "craftShaft", type: "process", x: 2970, y: 1075, title: "Crafting", subtitle: "2x andesite alloy" },
    { id: "shaft", type: "output", x: 3260, y: 1075, title: "Shaft" },
    { id: "planks", type: "input", x: 3260, y: 1205, title: "Planks" },
    { id: "craftCogwheel", type: "process", x: 3550, y: 1140, title: "Crafting", subtitle: "Shaft + planks" },
    { id: "cogwheel", type: "output", x: 3840, y: 1140, title: "Cogwheel" },
    { id: "sawKinetic", type: "process", x: 4130, y: 1040, title: "Saw", subtitle: "Cogwheel + alloy + log" },
    { id: "kineticMechanism", type: "output", x: 4420, y: 1040, title: "Kinetic Mechanism" },
    { id: "craftAndesiteMachine", type: "process", x: 4710, y: 955, title: "Crafting", subtitle: "8x mechanisms + casing" },
    { id: "andesiteMachine", type: "output", x: 5000, y: 955, title: "Andesite Machine", subtitle: "Basic machine block" },
    {
      id: "machineAttachment",
      type: "random",
      x: 5000,
      y: 1115,
      w: 260,
    ...
    { id: "specificMachine", type: "output", x: 5320, y: 1035, title: "Specific Machine Item", subtitle: "Fan machine, drill machine, etc." },
  ...
  edges: [
    ...
    { from: "andesiteAlloy", to: "craftAndesiteCasing" },
    { from: "log", to: "craftAndesiteCasing" },
    { from: "craftAndesiteCasing", to: "andesiteCasing" },
    { from: "andesiteAlloy", to: "craftShaft", label: "x2" },
    { from: "craftShaft", to: "shaft" },
    { from: "shaft", to: "craftCogwheel" },
    { from: "planks", to: "craftCogwheel" },
    { from: "craftCogwheel", to: "cogwheel" },
    { from: "cogwheel", to: "sawKinetic" },
    { from: "andesiteAlloy", to: "sawKinetic" },
    { from: "log", to: "sawKinetic" },
    { from: "sawKinetic", to: "kineticMechanism" },
    { from: "kineticMechanism", to: "craftAndesiteMachine", label: "x8" },
    { from: "andesiteCasing", to: "craftAndesiteMachine" },
    { from: "craftAndesiteMachine", to: "andesiteMachine" },
    { from: "andesiteMachine", to: "specificMachine" },
    { from: "machineAttachment", to: "specificMachine" },
