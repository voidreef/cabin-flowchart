const recipes = {
  nodes: [
    { id: "gravel", type: "input", x: 70, y: 80, title: "Gravel" },
    { id: "sand", type: "input", x: 70, y: 340, title: "Sand" },
    { id: "dirt", type: "input", x: 70, y: 570, title: "Dirt" },
    { id: "organic", type: "input", x: 70, y: 820, title: "Organic Material", subtitle: "Leaves, saplings, etc." },

    { id: "flintSieve1", type: "process", x: 360, y: 80, title: "Flint Sieve" },
    { id: "flintSieve2", type: "process", x: 360, y: 340, title: "Flint Sieve" },
    { id: "flintSieve3", type: "process", x: 360, y: 570, title: "Flint Sieve" },
    { id: "barrel", type: "process", x: 360, y: 760, title: "Barrel", subtitle: "Compost" },
    { id: "crucible", type: "process", x: 360, y: 900, title: "Crucible" },
    ...
    { id: "dirtOut", type: "output", x: 680, y: 770, title: "Dirt" },
    { id: "waterOut", type: "output", x: 680, y: 910, title: "Water" }
  ],
  edges: [
    { from: "gravel", to: "flintSieve1" },
    { from: "flintSieve1", to: "gravelDrops", label: "random" },
    { from: "sand", to: "flintSieve2" },
    { from: "flintSieve2", to: "sandDrops", label: "random" },
    { from: "dirt", to: "flintSieve3" },
    { from: "flintSieve3", to: "dirtDrops", label: "random" },
    { from: "organic", to: "barrel" },
    { from: "barrel", to: "dirtOut" },
